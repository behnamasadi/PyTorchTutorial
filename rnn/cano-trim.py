"""
https://gist.github.com/rongjiecomputer/94154e0bf01ef19a4999fef70264c48a
Original raw text:
...
"""
root_path="../data/rnn/herlock_holm/"
input = open(root_path+"cano.txt", "r")
output = open(root_path+"cano-trim.txt", "w")
